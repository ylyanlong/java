...
public class MyReflect {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Class<?> classOjbect3 = Class.forName("cn.com.Observer");
		} catch (ClassNotFoundException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} // 
		
		constructorObject("cn.com.Person");
		
		showDeclaredMethods("cn.com.Student");  // 并未出现 Object 相关的函数, Object 其实是二级父类, 可以测试下
		showDeclaredMethods("cn.com.Person");
		
		showDeclaredFields("cn.com.Student");
		
		getAllPublicFields("cn.com.Student");
	}
	
	// classPath = "cn.com.Person"
